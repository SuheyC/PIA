<template>
    <div class="contenedor-agregar-admin">
      <div class="formulario-admin">
        <h1 class="titulo">Agregar Administrador</h1>
        ...
        <div class="botones">
          <button @click="guardarAdmin" class="btn-guardar">Guardar</button>
  ...
  export default {
    ...
    methods: {
      ...
      guardarAdmin() {
        ...
        alert(`Administrador ${this.nombreUsuario} guardado.`);
        this.$router.push('/admin/usuariosAdmin');
      },
      cancelar() {
        if (
          this.nombreUsuario || this.correoElectronico ||
          this.numeroEmpleado || this.nuevaContrasena || this.imagenPreview
        ) {
