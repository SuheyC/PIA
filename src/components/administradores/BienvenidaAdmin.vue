    ...
    <div class="inicio-admin">
      ...
      <main class="contenido">
        <div class="bienvenida">
          ...
          <h3>Gestión de Asesorías</h3>
          <p>Aquí puedes gestionar las solicitudes de asesoría académica, supervisar el desempeño de los asesores, 
          generar informes y mucho más.</p>
        </div>
      </main>
    </div>
  </template>
...
<script>
  ...
  align-items: center;
  width: 100%;
  margin-top: 100px; /* Asegura espacio debajo del header */
  padding: 20px;
}
