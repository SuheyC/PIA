<template>
  ...
  export default {
    ...
    created() {
      const admin = JSON.parse(localStorage.getItem('adminEditar'));
      if (admin) {
        this.nombreUsuario = admin.nombre;
        this.correoElectronico = admin.correo;
        this.numeroEmpleado = admin.numeroEmpleado;
        this.imagenPreview = admin.foto || null;
      }
    },
    methods: {
      cargarImagen(event) {
      ...
      guardarCambios() {
        ...
        console.log('Administrador editado:', adminEditado);
