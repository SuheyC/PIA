  ...
  <div class="inicio-asesor">
    ...
    <main class="contenido">
      <div class="bienvenida">
        ...
        <h3>Panel de Gestión de Asesorías</h3>
        <p>Desde aquí puedes atender las solicitudes de los estudiantes, enviar mensajes, generar informes y mantener tu información actualizada.</p>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    if (usuario) {
      ...
      this.nombreUsuario = usuarioObj.nombre || 'Asesor';
...
<style scoped>
/* Todo el estilo es exactamente igual al que usas en la página de admin */
