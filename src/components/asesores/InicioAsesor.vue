    ...
    async iniciarSesion() {
      try {
        ...
        if (response.data.length > 0) {
          ...
          localStorage.setItem('rol', usuario.rol || 'asesor');

          console.log('Autenticación exitosa - Asesor');
...
<style scoped>
/* Copiamos el mismo CSS del componente de administrador */
.inicio-asesor {
