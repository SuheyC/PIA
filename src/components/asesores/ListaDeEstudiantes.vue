    ...
    <div class="inicio-admin">
      ...
      <main class="contenido">
        <div class="bienvenida">
          ...
          <div class="lista">
            <div v-for="estudiante in estudiantes" :key="estudiante.id" class="item-lista" @click="verPerfil(estudiante)">
              {{ estudiante.nombre }}
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    cerrarSesion() {
      ...
      verPerfil(estudiante) {
        this.$router.push({ name: 'PerfilEstudianteAsesor', params: { id: estudiante.id } });
      }
    }
  }
  </script>
