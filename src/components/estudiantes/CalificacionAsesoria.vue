<template>
    <div class="inicio-admin">
      ...
      <main class="contenido">
        ...
        <button class="btn-volver" @click="volverAListaCalificacion">
          ← Volver
        </button>
      </main>
    </div>
    ...
    data() {
      return {
        ...
        calificaciones: {
          ...
          entregaTareas: 100,
          compromiso: 100,
          desempenoExamenes: 100,
          habilidadesComunicacion: 100,
          cumplimientoNormas: 100,
          actitudProfesionalismo: 100,
          gestionTiempo: 100,
          satisfaccionGeneral: 100
        },
      };
    },
    created() {
      ...
      const estudiantes = [
        ...
        { id: 3, nombre: 'carlos martinez', carrera: 'Ingeniería Mecánica', semestre: '7°' }
      ];
