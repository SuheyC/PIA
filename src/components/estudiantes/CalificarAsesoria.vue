<template>
  ...
  return {
    calificacion: {
      asistencia: null,
      conocimiento: null,
      disposicion: null, // fusión de disponibilidad + compromiso
      profesionalismo: null, // fusión de actitud + profesionalismo
      comunicacion: null, // fusión de claridad + comunicación
      comentarios: ''
    },
    calificacionLabels: {
      asistencia: "Asistencia",
      conocimiento: "Conocimiento del tema",
      disposicion: "Disposición y compromiso",
      profesionalismo: "Actitud y profesionalismo",
      comunicacion: "Claridad y comunicación"
    },
    mensajeGraciasVisible: false
  };
},
  ...
  idAsesoria() {
    ...
    this.$router.push({ name: 'ReporteEstudiante' }); 
      ...
      cerrarAnuncio() {
        ...
        sessionStorage.setItem('anuncioVisto', 'true'); // Marcamos como visto
      },
      enviarCalificacion() {
        console.log("Calificación enviada:", this.calificacion);
        // Mostrar el mensaje de agradecimiento
        this.mensajeGraciasVisible = true;
        this.$router.push({ name: 'bienvenida-estudiante'})
      },
